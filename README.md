...
3. check for container run from docker for api can run propely, dbeaver, etc ![1](https://github.com/user-attachments/assets/53f1dd05-25a1-45e3-acc3-7dfa5d3f8fe2)
